...
export default async function RestaurantDetailPage( {params}: { params: {hid: string} } ) {
  ...
  mockRestaurantRepo.set("65e481c436609831cbcf660d", {
    ...
    "picture": "https://img.freepik.com/premium-photo/cafe-with-large-window-table-with-chairs_728472-653.jpg"
});
  mockRestaurantRepo.set("65e481c436609831cbcf65fa", {
    "_id": "65e481c436609831cbcf65fa",
    "ลำดับ": 75,
    "name": "ร้านก๋วยเตี๋ยว WWW",
    ...
    "picture": "https://www.shutterstock.com/image-photo/3d-render-cafe-bar-restaurant-600nw-1415138246.jpg"
});
  mockRestaurantRepo.set("65e481c436609831cbcf6613", {
    ...
    "picture": "https://www.so-bangkok.com/wp-content/uploads/sites/47/2023/04/1-4-DSC_8378.jpg"
});
